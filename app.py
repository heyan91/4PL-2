...
def inverse_4pl(y, a, b, c, d):
    """Returns x for a given y using inverse of 4PL"""
...
if data_input:
    try:
        # Try to handle both tab and comma separated
        df = pd.read_csv(pd.compat.StringIO(data_input), sep=None, engine="python")
        ...
        # Estimate LOD concentration from inverse 4PL
        try:
